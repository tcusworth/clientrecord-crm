...
sqlite.prepare("INSERT INTO ai_artifacts(id,run_id,feature,entity_type,entity_id,content_json,original_content_json,explanation,confidence,provider,model,prompt_version,input_hash,generated_by,generated_at) VALUES ('artifact-1','run-1','meeting-prep','deal','1','{\"summary\":\"Draft\"}','{\"summary\":\"Draft\"}','Source-backed draft',82,'openai','gpt-5-mini',2,'hash','owner@example.com',datetime('now'))").run();
