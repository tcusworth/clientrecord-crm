...
const button = (label: string, href = "https://fcstudio.us") => `<table role="presentation" cellspacing="0" cellpadding="0"><tr><td style="border-radius:8px;background:#3968ff"><a href="${href}" style="display:inline-block;padding:13px 22px;color:#ffffff;font:700 14px Arial,sans-serif;text-decoration:none">${label}</a></td></tr></table>`;
...
<tr><td class="mobile-pad" style="padding:22px 36px;border-top:5px solid ${accent}"><table role="presentation" width="100%"><tr><td style="font:800 16px Arial,sans-serif;color:#111b31">FLATIRONS CREATIVE STUDIO</td><td align="right" style="font:12px Arial,sans-serif;color:#667085">Customer update</td></tr></table></td></tr>
${content}
<tr><td class="mobile-pad" style="padding:28px 36px;background:#111b31;color:#aeb8cc;text-align:center;font:12px/1.7 Arial,sans-serif">Flatirons Creative Studio · [Add your mailing address]<br><a href="${unsubscribe}" style="color:#ffffff;text-decoration:underline">Unsubscribe</a> from marketing emails</td></tr>
...
export const emailTemplates: EmailTemplate[] = [
  ...
  },
  {
    ...
    layout: "showcase",
    textBody: `Hello ${firstName},\n\nTake a closer look at our latest project.\n\nTHE CHALLENGE\nDescribe the starting point.\n\nTHE RESULT\nExplain what changed and why it matters.\n\nView the project: https://fcstudio.us\n\nUnsubscribe: ${unsubscribe}`,
    html: shell(`<tr><td>${imageBlock("Project hero image", 300)}</td></tr><tr><td class="mobile-pad" style="padding:38px 36px"><div style="color:#3968ff;font:700 12px Arial,sans-serif;letter-spacing:.12em;text-transform:uppercase">Featured work</div><h1 style="margin:12px 0 16px;font:800 34px/1.15 Arial,sans-serif;color:#111b31">A project worth a closer look</h1><p style="margin:0 0 26px;color:#526079;font:16px/1.7 Arial,sans-serif">Hello ${firstName}. Describe the creative challenge, your approach, and the result in a story that is easy to scan.</p><table role="presentation" width="100%"><tr><td class="stack" width="48%" valign="top"><b>THE CHALLENGE</b><p style="color:#667085;font:14px/1.6 Arial,sans-serif">What needed to change?</p></td><td class="stack" width="4%"></td><td class="stack" width="48%" valign="top"><b>THE RESULT</b><p style="color:#667085;font:14px/1.6 Arial,sans-serif">What did the work achieve?</p></td></tr></table><div style="height:18px"></div>${button("View the project")}</td></tr>`, "#7457d9"),
  },
  {
    id: "welcome",
    name: "Welcome",
    ...
    subject: "Welcome to Flatirons Creative Studio",
    previewText: "Here’s what you can expect from us.",
    layout: "welcome",
    textBody: `Welcome, ${firstName}!\n\nThanks for joining us. We’ll send practical ideas, studio updates, and occasional project stories.\n\nExplore our work: https://fcstudio.us\n\nUnsubscribe: ${unsubscribe}`,
    html: shell(`<tr><td class="mobile-pad" align="center" style="padding:58px 36px 26px"><div style="width:64px;height:64px;line-height:64px;border-radius:50%;background:#e8edff;color:#3968ff;font:800 24px Arial,sans-serif">FC</div><h1 style="margin:22px 0 14px;font:800 36px/1.12 Arial,sans-serif;color:#111b31">Welcome, ${firstName}.</h1><p style="max-width:470px;margin:0 auto;color:#526079;font:16px/1.7 Arial,sans-serif">Thanks for joining us. We’ll send useful ideas, thoughtful studio updates, and occasional stories from our work.</p></td></tr><tr><td class="mobile-pad" style="padding:8px 36px 38px"><table role="presentation" width="100%"><tr><td style="padding:22px;background:#f5f7fb;border-radius:10px"><b>What to expect</b><p style="margin:8px 0 0;color:#667085;font:14px/1.7 Arial,sans-serif">Practical insights · Selected projects · Studio news</p></td></tr></table><div style="height:24px"></div>${button("Explore our work")}</td></tr>`, "#33a27b"),
  },
  {
    id: "two-column",
    ...
    html: shell(`<tr><td class="mobile-pad" style="padding:42px 36px 28px"><h1 style="margin:0 0 12px;font:800 34px/1.15 Arial,sans-serif;color:#111b31">Two ideas for ${firstName}</h1><p style="margin:0;color:#526079;font:16px/1.7 Arial,sans-serif">Use this balanced layout when two stories deserve equal attention.</p></td></tr><tr><td class="mobile-pad" style="padding:0 36px 42px"><table role="presentation" width="100%"><tr><td class="stack" width="48%" valign="top">${imageBlock("Image one", 170)}<h2 style="font:700 20px Arial,sans-serif">First story</h2><p style="color:#667085;font:14px/1.65 Arial,sans-serif">A short description that makes the reader want to learn more.</p>${button("Read more")}</td><td class="stack" width="4%"></td><td class="stack" width="48%" valign="top">${imageBlock("Image two", 170)}<h2 style="font:700 20px Arial,sans-serif">Second story</h2><p style="color:#667085;font:14px/1.65 Arial,sans-serif">A second concise description with a focused next step.</p>${button("Read more")}</td></tr></table></td></tr>`),
  },
  {
    id: "three-column",
  ...
  },
  {
    ...
    subject: "A quick note from Trevor",
